...
public interface InstrumentRepository extends JpaRepository<Instrument, Long> {
	...
	@Query("SELECT i FROM Instrument i JOIN FETCH i.borrower JOIN FETCH i.reservation WHERE i.id = :instrumentId")
	Optional<Instrument> findByInstrumentIdFetchJoinBorrowerAndReservation(@Param("instrumentId") Long instrumentId);
}
